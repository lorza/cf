  ...
  <div className="column is-4 messages hero is-fullheight" id="message-feed">
    <div className="action-buttons">
      ...
      <div className="control is-grouped pg">
        <div className="title">{{ paginate.pointer.start }}-{{ paginate.pointer.end }} of {{ paginate.total }}</div>
    ...
    <div className="inbox-messages" id="inbox-messages">
      <div v-for="(msg, index) in messages" className="card" v-bind:id="'msg-card-'+index" v-on:click="showMessage(msg,index)" v-bind:data-preview-id="index">
        <div className="card-content">
          <div className="msg-header">
            <span className="msg-from"><small>From: {{ msg.from }}</small></span>
            <span className="msg-timestamp"></span>
            <span className="msg-attachment"><i className="fa fa-paperclip"></i></span>
          </div>
          <div className="msg-subject">
            <span className="msg-subject"><strong id="fake-subject-1">{{ msg.subject }}</strong></span>
          </div>
